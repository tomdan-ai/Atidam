...
export default function ContactSection() {
    ...
    return (
        <section id="contact" ref={sectionRef} className="min-h-screen py-16 sm:py-20 md:py-28 lg:py-32 bg-white dark:bg-black flex flex-col justify-center border-t border-gray-50 dark:border-gray-900">
            <div className="max-w-[1600px] mx-auto px-5 sm:px-8 md:px-12 lg:px-16 w-full h-full flex flex-col lg:flex-row gap-10 sm:gap-12 md:gap-16 lg:gap-20 items-start">
                ...
                <div className="flex-1 flex flex-col gap-10 sm:gap-14 md:gap-16 lg:gap-20">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="bg-gray-50 dark:bg-gray-900 p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl lg:rounded-[2rem] flex items-center gap-4 sm:gap-5 md:gap-6 max-w-sm shadow-sm"
                    >
                ...
                <div ref={contentRef} className="flex-1 w-full flex flex-col gap-8 sm:gap-10 md:gap-12">
                    ...
                    <div className="flex justify-start sm:justify-end mt-2 sm:mt-4">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="w-full sm:w-auto bg-green-200 dark:bg-green-900/50 hover:bg-green-600 dark:hover:bg-green-600 hover:text-white text-green-900 dark:text-green-300 px-8 sm:px-10 md:px-12 py-4 sm:py-5 rounded-full font-bold transition-all text-base sm:text-lg md:text-xl shadow-sm hover:shadow-lg"
                        >
                            Submit
                        </motion.button>
                    </div>
