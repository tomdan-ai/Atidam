                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 md:gap-16 lg:gap-20 items-start">
                    ...
                    <div ref={rightRef} className="flex flex-col gap-6 sm:gap-8 md:gap-10 pt-0 lg:pt-10">
                        <div>
                            ...
                            <p className="text-gray-400 dark:text-gray-500 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed max-w-xl font-medium">
                    ...
                    {testimonials.map((t, idx) => (
                        ...
                        >
                            <div className="flex items-center gap-4 sm:gap-5 md:gap-6">
                                ...
                                <div>
                                    <h4 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-950 dark:text-white">{t.name}</h4>
                                    <p className="text-gray-400 dark:text-gray-500 font-semibold text-sm sm:text-base">{t.role}</p>
                                </div>
                            </div>

                            <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base md:text-lg leading-relaxed font-medium line-clamp-4 md:line-clamp-none">
                                {t.text}
                            </p>

                            <div className="flex items-center justify-between mt-auto pt-4 sm:pt-5 md:pt-6 border-t border-gray-50 dark:border-gray-800">
